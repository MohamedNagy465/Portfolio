...
export default function About() {
  ...
  return (
    <section
      id="about"
      className=" px-6 py-12 bg-gray-50 dark:bg-gray-900 transition-colors duration-500"
    >
      <h2
      ...
      >
        {/* النص الأساسي */}
        <div className="bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-10 border border-gray-300 dark:border-gray-600 hover:shadow-purple-500 hover:scale-105 transition-all duration-300 text-center sm:text-left">
        ...
        {/* الكارت الإضافي */}
        <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-300 dark:border-purple-700 hover:shadow-purple-500 transition-all duration-300 rounded-xl p-8 shadow-lg hover:scale-105 text-center sm:text-left">
